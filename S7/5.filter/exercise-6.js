...
const streamLegend = streamers.filter(user => user.gameMorePlayed.includes('Legends'))


const streamLegend2 = streamLegend.map(user => user.gameMorePlayed.includes('Legends') && user.age > 35 ? user.gameMorePlayed.toUpperCase(): user.gameMorePlayed)
console.log(streamLegend2);